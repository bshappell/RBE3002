...
if("FALSE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/rbe/RBE3002/src/lab3)
  set(lab3_DEVEL_PREFIX /home/rbe/RBE3002/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/rbe/RBE3002/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'nkjefferson <nkjefferson@wpi.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rbe/RBE3002/install/${idir}'.  Ask the maintainer 'nkjefferson <nkjefferson@wpi.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rbe/RBE3002/install/lib;/home/rbe/RBE3002/devel/lib;/home/rbe/Ros_ws/devel/lib;/opt/ros/indigo/lib)
