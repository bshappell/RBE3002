...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rbe/RBE3002/src/lab3/${idir}'.  Ask the maintainer 'nkjefferson <nkjefferson@wpi.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rbe/RBE3002/devel/lib;/home/rbe/RBE3002/devel/lib;/home/rbe/Ros_ws/devel/lib;/opt/ros/indigo/lib)
